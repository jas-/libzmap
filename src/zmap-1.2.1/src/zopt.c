/*
  ...
  gengetopt -C --no-help --no-version --unamed-opts=SUBNETS -i /home/jas/software/zmap-1.2.1/src/zopt.ggo -F /home/jas/software/zmap-1.2.1/src/zopt 
...
void init_args_info(struct gengetopt_args_info *args_info)
{
  ...
  args_info->metadata_file_help = gengetopt_args_info_help[40] ;
  args_info->ignore_invalid_hosts_help = gengetopt_args_info_help[41] ;
  ...
  while (1)
    {
      ...
      c = getopt_long (argc, argv, "p:o:b:w:f:n:N:t:r:B:c:e:T:P:ds:S:G:i:XM:O:C:l:L:qgv:hV", long_options, &option_index);
